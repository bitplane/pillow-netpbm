...
SYNTHETIC_FORMATS = [
    ...
    ("facesaver", "jimf.face", "fstopgm", "NETPBM_USENIX_FACESAVER"),
    ("facesaver", "rms.face", "fstopgm", "NETPBM_USENIX_FACESAVER"),
    ("facesaver", "max.fs", "fstopgm", "NETPBM_USENIX_FACESAVER"),
    ("fiasco", "test.wfa", "fiascotopnm", "NETPBM_FIASCO_WAVELET"),
    ("fiasco", "abydos.fco", "fiascotopnm", "NETPBM_FIASCO_WAVELET"),
    ("fiasco", "monarch.fco", "fiascotopnm", "NETPBM_FIASCO_WAVELET"),
    ("fiasco", "lena.fco", "fiascotopnm", "NETPBM_FIASCO_WAVELET"),
    ("fits", "test.fits", "fitstopnm", "NETPBM_FITS"),
    ("fits", "input.fits", "fitstopnm", "NETPBM_FITS"),
    ("fits", "M57.FIT", "fitstopnm", "NETPBM_FITS"),
    ("fits", "MOON.FTS", "fitstopnm", "NETPBM_FITS"),
    ("garmin-srf", "test.srf", "srftopam", "NETPBM_GARMIN_SRF"),
    ("gem-raster", "test.gem", "gemtopnm", "NETPBM_GEM_RASTER"),
    ("gem-raster", "TIGER.IMG", "gemtopnm", "NETPBM_GEM_RASTER"),
    ("gem-raster", "BEAR.IMG", "gemtopnm", "NETPBM_GEM_RASTER"),
    ("gem-raster", "atari.img", "gemtopnm", "NETPBM_GEM_RASTER"),
    ("group3-fax", "test.g3", "g3topbm", "NETPBM_GROUP_3_FAX"),
    ("group3-fax", "TESTDOC.G3", "g3topbm", "NETPBM_GROUP_3_FAX"),
    ("group3-fax", "tm.g3", "g3topbm", "NETPBM_GROUP_3_FAX"),
    ("group3-fax", "kde.g3", "g3topbm", "NETPBM_GROUP_3_FAX"),
    ("hp-paintjet", "test.pj", "pjtoppm", "NETPBM_HP_PAINTJET"),
    ("interleaf", "test.leaf", "leaftoppm", "NETPBM_INTERLEAF"),
    ("interleaf", "FANEUALL.IMG", "leaftoppm", "NETPBM_INTERLEAF"),
    ("interleaf", "abydos.iimg", "leaftoppm", "NETPBM_INTERLEAF"),
    ("jbig", "test.jbig", "jbigtopnm", "NETPBM_JBIG"),
    ("jbig", "ccitt1.jbg", "jbigtopnm", "NETPBM_JBIG"),
    ("jbig", "ccitt2.bie", "jbigtopnm", "NETPBM_JBIG"),
    ("jbig", "xvlogo.jbg", "jbigtopnm", "NETPBM_JBIG"),
    ("lisp-machine", "test.lispm", "lispmtopgm", "NETPBM_LISP_MACHINE_BITMAP"),
    ("macpaint", "test.macp", "macptopbm", "NETPBM_MACPAINT"),
    ("macpaint", "elvis.mac", "macptopbm", "NETPBM_MACPAINT"),
    ("macpaint", "cactus.mac", "macptopbm", "NETPBM_MACPAINT"),
    ("macpaint", "SUPERMAN.MAC", "macptopbm", "NETPBM_MACPAINT"),
    ("macpaint", "UNeedQT4.pntg", "macptopbm", "NETPBM_MACPAINT"),
    ("mgr-bitmap", "test.mgr", "mgrtopbm", "NETPBM_MGR_BITMAP"),
    ("mgr-bitmap", "chess", "mgrtopbm", "NETPBM_MGR_BITMAP"),
    ("mgr-bitmap", "mickface", "mgrtopbm", "NETPBM_MGR_BITMAP"),
    ("mgr-bitmap", "stopsign", "mgrtopbm", "NETPBM_MGR_BITMAP"),
    ("mgr-bitmap", "buttons", "mgrtopbm", "NETPBM_MGR_BITMAP"),
    ("microdesign", "test.mda", "mdatopbm", "NETPBM_MICRODESIGN"),
    ("microdesign", "head.mda", "mdatopbm", "NETPBM_MICRODESIGN"),
    ("microdesign", "alpha.mda", "mdatopbm", "NETPBM_MICRODESIGN"),
    ("microdesign", "castle.mda", "mdatopbm", "NETPBM_MICRODESIGN"),
    ("neochrome", "frog.neo", "neotoppm", "NETPBM_ATARI_NEOCHROME"),
    ("neochrome", "bear.neo", "neotoppm", "NETPBM_ATARI_NEOCHROME"),
    ...
    ("palm-db", "dobbs.pdb", "pdbimgtopam", "NETPBM_PALM_DB_IMAGE"),
    ("palm-db", "dollar.pdb", "pdbimgtopam", "NETPBM_PALM_DB_IMAGE"),
    ("palm-db", "tattoo.pdb", "pdbimgtopam", "NETPBM_PALM_DB_IMAGE"),
    ("sbig", "test.sbig", "sbigtopgm", "NETPBM_SBIG_CCD_CAMERA"),
    ("sbig", "4rings.sbig", "sbigtopgm", "NETPBM_SBIG_CCD_CAMERA"),
    ("sbig-st4", "test.st4", "st4topgm", "NETPBM_SBIG_ST_4_CCD_CAMERA"),
    ("solitaire", "test.sir", "sirtopnm", "NETPBM_SOLITAIRE"),
    ("sun-icon", "emacs.icon", "sunicontopnm", "NETPBM_SUN_ICON"),
    ("sun-icon", "puzzle.icon", "sunicontopnm", "NETPBM_SUN_ICON"),
    ("sun-icon", "sun.ico", "sunicontopnm", "NETPBM_SUN_ICON"),
    ("sun-icon", "terminal.icon", "sunicontopnm", "NETPBM_SUN_ICON"),
    ...
    ("wireless-bitmap", "welcome.wbmp", "wbmptopbm", "NETPBM_WIRELESS_BITMAP"),
    ("wireless-bitmap", "hpc.wbmp", "wbmptopbm", "NETPBM_WIRELESS_BITMAP"),
    ("wireless-bitmap", "input.wbmp", "wbmptopbm", "NETPBM_WIRELESS_BITMAP"),
    ("xv-thumbnail", "test.xvmini", "xvminitoppm", "NETPBM_XV_THUMBNAIL"),
    ("xv-thumbnail", "input.p7", "xvminitoppm", "NETPBM_XV_THUMBNAIL"),
    ("xv-thumbnail", "critical", "xvminitoppm", "NETPBM_XV_THUMBNAIL"),
    ("xv-thumbnail", "coral3.ppm", "xvminitoppm", "NETPBM_XV_THUMBNAIL"),
    ("xim", "smack.xim", "ximtoppm", "NETPBM_X_IMAGE"),
    ("xim", "tea.xim", "ximtoppm", "NETPBM_X_IMAGE"),
    ("xwd", "test.xwd", "xwdtopnm", "NETPBM_X_WINDOW_DUMP"),
    ("xwd", "input.xwd", "xwdtopnm", "NETPBM_X_WINDOW_DUMP"),
    ("xwd", "screen.xwd", "xwdtopnm", "NETPBM_X_WINDOW_DUMP"),
    ("xwd", "betyboop.dmp", "xwdtopnm", "NETPBM_X_WINDOW_DUMP"),
